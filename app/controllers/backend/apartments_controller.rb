class Backend::ApartmentsController < BackendController
    ...
    def apartment_params
        params.require(:apartment).permit(:name, :address, :postal_code, :city, :province, :lat, :lng, :capacity, :square_meters, :rooms, :bedrooms, :toilette, :area_id, :main_image, :in_evidence, :published, :on_selling, :price_selling, :content, :price_default, :price_cleaning_service, :images => [], :service_ids => [])
    end
end
