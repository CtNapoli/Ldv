class Backend::ApartmentsController < BackendController
    ...
    def apartment_params
        params.require(:apartment).permit(:name, :address, :postal_code, :city, :province, :lat, :lng, :capacity, :square_meters, :rooms, :bedrooms, :toilette, :area_id, :main_image, :images => [])
    end
end
